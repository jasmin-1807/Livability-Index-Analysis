...
groups = [Group('Health Score',['Perzentil_Satisfaction', 'Inverted_Perzentil_Smoking', 'Inverted_Perzentil_Obesity', 'Inverted_Hospitalization_Perzentil', 'Perzentil', 'Inverted_HealthcareShortage_Perzentil']), 
          ...
          Group('Housing Score', ['Perzentil_MultiFamily', 'Perzentil_SubsidizedUnits']),
          Group('Transportation Score',['Inverted_Perzentil_CrashRate', 'Perzentil_ADA', 'Inverted_Perzentil_SpeedLimits'])] 
...
output_path = os.path.join(base_dir, 'Category Scores with Parts of Housing & Transp', f'FinalCategoryScores_StateMean_WithPartofHousingandTransportation{year}.csv')
